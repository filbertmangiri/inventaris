    ...
    <x-container>
        ...
        <div class="col-12">
            <div class="alert alert-info d-flex align-items-center" role="alert">
                <i class="fas fa-smile mr-2 fa-lg"></i>
                Selamat datang! Anda dapat mulai memeriksa permintaan barang kapan saja.
                <a href="{{ route('admin.order.index') }}" class="ml-1">Lihat Permintaan Barang</a>
            </div>
        </div>
        ...
        {{-- <div class="col-12">
            ...
            @else
                <div class="alert alert-danger d-flex align-items-center" role="alert">
                    <i class="fas fa-info-circle mr-2 fa-lg"></i>
                    Saat ini terdapat {{ $pendingOrdersCount }} permintaan barang menunggu konfirmasi.
